 ...
 * 
 */
public class SparqlQuery_1bLIPIDMAPS_Jenkins {

	public static void main(String[] args) throws Exception {
		//String sparqlUrl = "http://sparql.wikipathways.org";
		String sparqlUrl = "http://localhost:9999/blazegraph/sparql";
		File out = new File("sparql-resultB-wdLIPID_MAPS-20201116-wpallDev.txt");
		
		SparqlQuery_1bLIPIDMAPS_Jenkins sq = new SparqlQuery_1bLIPIDMAPS_Jenkins(sparqlUrl, out);
		sq.executeQuery();
	}
	...
	public SparqlQuery_1bLIPIDMAPS_Jenkins(String sparqlUrl, File out) {
	...
	private String getQuery() {
		...
		String queryString = "PREFIX gpml: <http://vocabularies.wikipathways.org/gpml#> " +
				...
				"SELECT DISTINCT ?interaction ?sourceDb ?targetDb ?PWOnt ?DiseaseOnt ?curationstatus ?InteractionRef ?PWref ?sourceLit ?targetLit " + 
				"WHERE { " + 
