 ...
 *
 */
public class SparqlQuery_1aLIPIDMAPS_Jenkins {

	public static void main(String[] args) throws Exception {
		//String sparqlUrl = "http://sparql.wikipathways.org";
		String sparqlUrl = "http://localhost:9999/blazegraph/sparql";
		File out = new File("sparql-resultA-wdLIPID_MAPS-20201116-wpallDev.txt");
		
		SparqlQuery_1aLIPIDMAPS_Jenkins sq = new SparqlQuery_1aLIPIDMAPS_Jenkins(sparqlUrl, out);
		sq.executeQuery();
	}
	...
	public SparqlQuery_1aLIPIDMAPS_Jenkins(String sparqlUrl, File out) {
	...
	private String getQuery() {
		...
		String queryString = "PREFIX gpml: <http://vocabularies.wikipathways.org/gpml#> " +
			...
			"PREFIX cas:     <http://identifiers.org/cas/> " +
				...
				"               dc:title ?titleLit . " +
				"FILTER (EXISTS {?pathway wp:ontologyTag cur:LIPID_MAPS}) . " + //|| EXISTS {?pathway wp:ontologyTag cur:Reactome_Approved}) . " + //comment this line for all pathways
