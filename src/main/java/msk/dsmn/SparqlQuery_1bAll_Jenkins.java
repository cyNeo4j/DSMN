 ...
 * 
 */
public class SparqlQuery_1bAll_Jenkins {

	public static void main(String[] args) throws Exception {
		//String sparqlUrl = "http://sparql.wikipathways.org";
		String sparqlUrl = "http://localhost:9999/blazegraph/sparql";
		File out = new File("sparql-resultB-wdAll-20201116-wpallDev.txt");
		
		SparqlQuery_1bAll_Jenkins sq = new SparqlQuery_1bAll_Jenkins(sparqlUrl, out);
		sq.executeQuery();
	}
	...
	public SparqlQuery_1bAll_Jenkins(String sparqlUrl, File out) {
