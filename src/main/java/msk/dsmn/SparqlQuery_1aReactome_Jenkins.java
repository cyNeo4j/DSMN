 ...
 *
 */
public class SparqlQuery_1aReactome_Jenkins {

	public static void main(String[] args) throws Exception {
		//String sparqlUrl = "http://sparql.wikipathways.org";
		String sparqlUrl = "http://localhost:9999/blazegraph/sparql";
		File out = new File("sparql-resultA-wdReactome-20201116-wpallDev.txt");
		
		SparqlQuery_1aReactome_Jenkins sq = new SparqlQuery_1aReactome_Jenkins(sparqlUrl, out);
		sq.executeQuery();
	}
	...
	public SparqlQuery_1aReactome_Jenkins(String sparqlUrl, File out) {
	...
	private String getQuery() {
		...
		String queryString = "PREFIX gpml: <http://vocabularies.wikipathways.org/gpml#> " +
			...
			"PREFIX cas:     <http://identifiers.org/cas/> " +
				...
				"               dc:title ?titleLit . " +
				"FILTER (EXISTS {?pathway wp:ontologyTag cur:Reactome_Approved}) . " + //|| EXISTS {?pathway wp:ontologyTag cur:AnalysisCollection}) . " + //comment this line for all pathways
