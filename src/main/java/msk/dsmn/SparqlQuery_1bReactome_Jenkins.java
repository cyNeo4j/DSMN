 ...
 * 
 */
public class SparqlQuery_1bReactome_Jenkins {

	public static void main(String[] args) throws Exception {
		//String sparqlUrl = "http://sparql.wikipathways.org";
		String sparqlUrl = "http://localhost:9999/blazegraph/sparql";
		File out = new File("sparql-resultB-wdReactome-20201116-wpallDev.txt");
		
		SparqlQuery_1bReactome_Jenkins sq = new SparqlQuery_1bReactome_Jenkins(sparqlUrl, out);
		sq.executeQuery();
	}
	...
	public SparqlQuery_1bReactome_Jenkins(String sparqlUrl, File out) {
