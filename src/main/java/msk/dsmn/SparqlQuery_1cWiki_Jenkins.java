 ...
 *
 */
public class SparqlQuery_1cWiki_Jenkins {

	public static void main(String[] args) throws Exception {
		//String sparqlUrl = "http://sparql.wikipathways.org";
		String sparqlUrl = "http://localhost:9999/blazegraph/sparql";
		File out = new File("sparql-resultC-wdWiki-20201116-wpallDev.txt");
		
		SparqlQuery_1cWiki_Jenkins sq = new SparqlQuery_1cWiki_Jenkins(sparqlUrl, out);
		sq.executeQuery();
	}
	...
	public SparqlQuery_1cWiki_Jenkins(String sparqlUrl, File out) {
