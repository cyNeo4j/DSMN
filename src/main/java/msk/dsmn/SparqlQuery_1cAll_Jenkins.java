 ...
 *
 */
public class SparqlQuery_1cAll_Jenkins {

	public static void main(String[] args) throws Exception {
		//String sparqlUrl = "http://sparql.wikipathways.org";
		String sparqlUrl = "http://localhost:9999/blazegraph/sparql";
		File out = new File("sparql-resultC-wdAll-20201116-wpallDev.txt");
		
		SparqlQuery_1cAll_Jenkins sq = new SparqlQuery_1cAll_Jenkins(sparqlUrl, out);
		sq.executeQuery();
	}
	...
	public SparqlQuery_1cAll_Jenkins(String sparqlUrl, File out) {
