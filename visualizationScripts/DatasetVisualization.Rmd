...
```{r}
##Load package to trim spaces around values for better macthing in Cytoscape
...
createNetworkFromDataFrames(nodes, edges, title="trial", collection="MTBLS265")
